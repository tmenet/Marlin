 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000,900,25,2000}
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -3.50  // Z offset: -below +above  [the nozzle]
...
// #define MIN_SOFTWARE_ENDSTOPS temporary ***********************************************************************************************
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 12       // Number of LEDs in the strip
